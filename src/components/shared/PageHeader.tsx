  ...
  return (
    <div className="mb-2 lg:mb-2">
      ...
      >
        ...
        <div className="flex w-full flex-wrap items-center gap-3 lg:w-auto lg:flex-nowrap lg:gap-2">
      ...
      <div
        className={`lg:hidden flex items-center justify-between gap-3 overflow-hidden transition-all duration-300 ease-out ${scrolledDown ? 'max-h-12 opacity-100 mb-2' : 'max-h-0 opacity-0 mb-0 pointer-events-none'}`}
      >
