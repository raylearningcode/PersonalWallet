...
export function Sidebar({ profileOpen, onProfileOpenChange }: {
  ...
  return (
    <>
      <aside className="relative z-10 mx-4 mt-4 hidden w-[calc(100%-2rem)] flex-col rounded-[1.7rem] border border-border bg-background/78 px-5 py-5 lg:fixed lg:left-5 lg:top-5 lg:m-0 lg:flex lg:w-[240px] lg:overflow-y-auto lg:px-4 lg:py-5" style={{ maxHeight: 'calc(100vh - 2.5rem)' }}>
        {/* Logo */}
