...
export function AppLayout() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main
        className="min-h-screen w-full overflow-x-hidden px-4 pt-[max(2.5rem,calc(env(safe-area-inset-top,0px)+0.75rem))] pb-28 sm:px-6 lg:ml-[240px] lg:w-[calc(100%-240px)] lg:max-w-[1150px] lg:pl-0 lg:pr-8 lg:pt-3 lg:pb-8 xl:max-w-[1300px] 2xl:max-w-[1450px]"
