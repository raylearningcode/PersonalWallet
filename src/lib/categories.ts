...
export const DEFAULT_BUDGET_CATEGORIES: Array<Omit<BudgetCategory, 'id' | 'created_at'>> = [
  { name: 'Housing', yearly_allocated: 0, budget_period: 'monthly', color: '#A9F5C7' },
  { name: 'Food', yearly_allocated: 0, budget_period: 'monthly', color: '#FFD276' },
  { name: 'Transport', yearly_allocated: 0, budget_period: 'monthly', color: '#93C5FD' },
  { name: 'Learning', yearly_allocated: 0, budget_period: 'monthly', color: '#C4AEFF' },
